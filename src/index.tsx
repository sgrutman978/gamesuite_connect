import { getFullnodeUrl, PaginatedObjectsResponse, QueryEventsParams, SuiClient, SuiClientOptions, SuiEvent, SuiEventFilter, SuiObjectData } from '@mysten/sui/client';
import { coinWithBalance, Transaction } from '@mysten/sui/transactions';
import { SuiObjectResponse } from '@mysten/sui/client';
// import { Profile } from './GameBoard';
import { SuiClientProvider, useSignAndExecuteTransaction, WalletProvider } from '@mysten/dapp-kit';
...
export function GameSuiteLoginModal({ onSuccess }: LoginFormProps) {
...
export function SubmitScoreComponent() {
    const { mutate: signAndExecuteTransaction } = useSignAndExecuteTransaction();
